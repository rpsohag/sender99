            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{translate('Org Stock')}}</th>
                        ...
                        <td>
                            @php
                                ...
                                if($product->variant_product) {
                                    foreach ($product->stocks as $key => $stock) {
                                        $o_qty += $stock->o_qty;
                                        echo $stock->variant.' - '.$stock->o_qty.'<br>';
                                    }
                                }
                                else {
                                    //$o_qty = $product->current_stock;
                                    $o_qty = optional($product->stocks->first())->o_qty;
                                    echo $o_qty;
                                }
                            @endphp
                            @if($o_qty <= $product->low_stock_quantity)
                                <span class="badge badge-inline badge-danger">Low</span>
                            @endif
                        </td>
                        <td>
