...
<div class="card mb-3">
    ...
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="https://laravel-multi.99coder.xyz/admin/orders/list/pending" style="background: #FFFFFF">
        <div class="card-body">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="https://laravel-multi.99coder.xyz/admin/orders/list/confirmed" style="background: #FFFFFF;">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: left;">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="https://laravel-multi.99coder.xyz/admin/orders/list/processing" style="background: #FFFFFF">
        <div class="card-body">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="https://laravel-multi.99coder.xyz/admin/orders/list/out_for_delivery" style="background: #FFFFFFff">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: left;">
    ...
    <div class="card card-body" style="background: #FFFFFF!important;">
        <div class="row gx-lg-4">
            <div class="col-sm-6 col-lg-3">
                <div class="media flex-between align-items-center" style="cursor: pointer" onclick="location.href='https://laravel-multi.99coder.xyz/admin/orders/list/delivered'">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media flex-between align-items-center" style="cursor: pointer" onclick="location.href='https://laravel-multi.99coder.xyz/admin/orders/list/canceled'">
                    <div class="media-body" style="text-align: left;">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-lg">
                <div class="media flex-between align-items-center" style="cursor: pointer" onclick="location.href='https://laravel-multi.99coder.xyz/admin/orders/list/returned'">
                    <div class="media-body" style="text-align: left;">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media flex-between align-items-center" style="cursor: pointer" onclick="location.href='https://laravel-multi.99coder.xyz/admin/orders/list/failed'">
                    <div class="media-body" style="text-align: left;">
