...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        if ($request->search != null) {
            ...
            $products = $products
                ...
                ->orwhere('barcode', 'like', '%' . $sort_search . '%')
    ...
    public function store(ProductRequest $request)
    {
        $product = $this->productService->store($request->except([
            '_token', 'sku', 'o_qty', 'choice', 'tax_id', 'tax', 'tax_type', 'flash_deal_id', 'flash_discount', 'flash_discount_type'
        ]));
        ...
        $this->productStockService->store($request->only([
            'colors_active', 'colors', 'choice_no', 'unit_price', 'sku', 'o_qty', 'current_stock', 'product_id'
        ]), $product);
